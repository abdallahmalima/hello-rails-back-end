...
This project is a api created by using rails framework  to be consumed by react front end app.
...
Feel free to check the [issues page](https://github.com/abdallahmalima/hello-rails-back-end/issues).
